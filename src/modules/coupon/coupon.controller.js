...
export const updateCoupon = async (req, res) => {
  ...
  const hiddenDetails = `courses=${req.body.courses.join(',')}&expDate=${coupon.expirationDate}&channelId=${req.body.newFields.channelId}&userName=${req.body.ownerDetails.name}`;
